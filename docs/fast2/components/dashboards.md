...
![Dashboard for exception table](../assets/img/components/dashboards_visualization-exception-table.png)
...
![Dashboard for campaign success ratio](../assets/img/components/dashboards_visualization-campaign-ratio.png)
