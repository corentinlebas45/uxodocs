...
Il est possible de définir au préalable différents comportements vis à
vis de la création d''annotation dans ARender. Cette configuration se
...
défaut dans _arender-default.properties_,
